                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">
                                        <button
                                            ...
                                            class="relative flex items-center rounded px-2 py-1 leading-tight transition-colors hover:bg-gray-200/50 hover:shadow"
                                            x-data="{ open: false }"
                                            @mouseover="open = true"
                                            @mouseout="open = false">
                                            Price
                                            <span
                                                class="text-nowrap absolute -translate-x-1/2 translate-y-6 rounded bg-gray-200 p-1 text-[10px] leading-tight shadow"
                                                x-show="open"
                                                x-cloak
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr class="border-b dark:border-gray-700">
                                        <th
                                            scope="row"class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                            {{ $product['id'] }}</th>
                                        <td class="px-4 py-3">{{ $product['title'] }}</td>
                                        <td class="text-ellipsis px-4 py-3">
